...
builder.Services.AddIdentity<AuthenticationIdentityUser, AuthenticationIdentityRoles>().AddEntityFrameworkStores<ApplicationDbContext>().AddDefaultTokenProviders();
